...
import { scanRepository, type ScanResult } from '../core/repoScanner.js';
import { detectFramework, type FrameworkInfo } from '../core/frameworkDetector.js';
import { classifyFiles } from '../core/fileClassifier.js';
import { analyzeArchitecture, type ArchitectureResult } from '../core/architectureAnalyzer.js';
import { readCodeContents, summarizeContents, type ContentSummary, type FileContent } from '../core/contentReader.js';
...
function generateSmartAgents(
  ...
  s.push(`> Generated by RepoLens AI v3.1.1 on ${new Date().toISOString().split('T')[0]}.`);
  s.push('');
